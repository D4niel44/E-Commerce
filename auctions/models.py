...
class Listing(models.Model):
    ...
    status = models.ForeignKey('Status', on_delete=models.PROTECT, related_name='listings')
    ...
    actual_bid = models.OneToOneField('Bid', on_delete=models.PROTECT, blank=True, related_name='listing_active_bid')
